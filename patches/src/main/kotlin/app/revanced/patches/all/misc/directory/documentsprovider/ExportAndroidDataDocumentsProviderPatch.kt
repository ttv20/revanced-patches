...
val exportAndroidDataDocumentsProviderPatch = resourcePatch(
    ...
    dependsOn(
        bytecodePatch {
            extendWith("extensions/all/misc/directory/documentsprovider/export-android-data-documents-provider.rve")
        },
    )

    execute {
        val documentsProviderClass =
            "app.revanced.extension.all.misc.directory.documentsprovider.AndroidDataDocumentsProvider"
