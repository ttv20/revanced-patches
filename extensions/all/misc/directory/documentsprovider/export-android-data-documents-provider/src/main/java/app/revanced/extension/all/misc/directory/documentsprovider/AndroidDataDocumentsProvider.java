...
/**
 * A DocumentsProvider that allows access to the app's Android/Data directory.
 */
@SuppressLint("LongLogTag")
public class AndroidDataDocumentsProvider extends DocumentsProvider {
    ...
    private File androidDataDirectory;
    ...
    private static boolean deleteRecursively(File root) {
        ...
        if (root.isDirectory()) {
            try {
                ...
                Log.e("AndroidDataDocumentsProvider", "Failed to lstat " + root.getPath(), e);
            }
        }
    ...
    public final void attachInfo(Context context, ProviderInfo providerInfo) {
        ...
        // Get the Android/Data/<package_name> directory
        this.androidDataDirectory = new File(Environment.getExternalStorageDirectory(),
                "Android/data/" + this.packageName);
    }
    ...
    public final Cursor queryRoots(String[] projection) {
        ...
        row.add(DocumentsContract.Root.COLUMN_TITLE, appName + " - Android/Data");
    ...
    private File resolveDocumentId(String fullContentPath) throws FileNotFoundException {
        ...
        // Resolve the relative path within Android/data/{PKG}
        File file;
        if (path.equals("/") || path.isEmpty()) {
            file = this.androidDataDirectory;
            
            // Create the directory if it doesn't exist
            if (!file.exists()) {
                if (!file.mkdirs()) {
                    throw new FileNotFoundException("Could not create Android/data directory for " + this.packageName);
                }
            }
        } else {
            // Remove leading slash
            String relativePath = path.substring(1);
            file = new File(this.androidDataDirectory, relativePath);
        }
    ...
    private void addRowForDocument(MatrixCursor cursor, String documentId, File file) throws FileNotFoundException {
        ...
        try {
            ...
            Log.e("AndroidDataDocumentsProvider", "Failed to get lstat info for " + path, ex);
        }
    }
}